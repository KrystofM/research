...
class SideBar extends HTMLElement {
  ...
  async loadNewerChanges() {
    ...
    // TODO detect deleted changes (redo). This is quite impossible without WebSockets or SSEs

    // TODO changes are loaded twice (are they?)
  ...
  async fillChangesCards() {
    ...
    // TODO an endpoint to get the latest change on a terminal would be cooler than what we do now.
    let attempts = 0;
