...
class PlannerHeader extends HTMLElement {
  optimiseAllCallback;
  optimiseAutoCallback;
  optimiseManualCallback;
  dateCallback;
  timeFrom;
  timeTo;
  view;
          ...
          div('planner-header-sub-in', [
            elCC('full-button-group', {}, [], [
              ...
              el('full-button', {
                ...
                icon: 'fire',
                size: FullButton.SIZE.large,
                onclick: this.optimiseManualCallback,
                view: FullButton.VIEW.secondary
              }),
              el('full-button', {
                textContent: '+ Unscheduled',
                icon: 'fire-flame-curved',
                size: FullButton.SIZE.large,
                onclick: this.optimiseAllCallback,
                view: FullButton.VIEW.secondary
              })
            ])
          ])
